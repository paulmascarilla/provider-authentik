...
import (
	...
	"github.com/crossplane/provider-authentik/apis"
	authentik "github.com/crossplane/provider-authentik/internal/controller"
	"github.com/crossplane/provider-authentik/internal/version"
)

func main() {
	var (
		app            = kingpin.New(filepath.Base(os.Args[0]), "Authentik support for Crossplane.").DefaultEnvars()
	...
	kingpin.FatalIfError(authentik.SetupGated(mgr, o), "Cannot setup Authentik controllers")
